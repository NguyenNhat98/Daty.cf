...
return [
    ...
    'element_config' => [
        ...
        'logo'    => [
            'restrictions' => [
                'allowedFileTypes'  => ['image/png', 'image/PNG', 'image/svg', 'image/svg+xml','image/jpg', 'image/JPG']
            ]
        ],
        'small_logo'    => [
            'restrictions' => [
        ...
        'favicon'    => [
            'restrictions' => [
                'allowedFileTypes'  => ['image/ico','image/jpg', 'image/JPG']
            ]
        ],
        'profile' => [
            'restrictions' => [
        ...
        'messenger' => [
            'restrictions' => [
                'allowedFileTypes'  => ['image/jpg', 'image/JPG', 'image/jpeg', 'image/JPEG', 'image/png','image/gif']
            ]
        ],
        'language' => [
            'restrictions' => [
