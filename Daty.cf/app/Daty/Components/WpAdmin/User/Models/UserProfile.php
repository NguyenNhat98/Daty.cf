...
use App\Daty\Components\WpAdmin\UserSetting\Models\UserSpecificationModel;
...
class UserProfile extends BaseModel
{
    ...
    public function scopeDistanceFilter($query, $inputData)
    {
        ...
        $rawQuery = sprintf(
                    '('.$measure.' * acos(cos(radians(%1$.7f)) * cos(radians(location_latitude))
                    * cos(radians(location_longitude) - radians(%2$.7f))
                    + sin(radians(%1$.7f))
