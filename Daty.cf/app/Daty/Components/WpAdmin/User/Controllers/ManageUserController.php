...
namespace App\Daty\Components\WpAdmin\User\Controllers;

use App\Daty\Base\BaseController;
use App\Daty\Components\WpAdmin\User\Requests\{
    UserAddRequest, UserUpdateRequest, GenerateFakeUsers
};
use App\Daty\Components\WpAdmin\User\ManageUserEngine;
...
class ManageUserController extends BaseController
{
    ...
    {
        return $this->loadManageView('WpAdmin.user.manage.list');
    }
    ...
    {
        return $this->loadManageView('WpAdmin.user.photos.list');
    }
    ...
    {
        return $this->loadManageView('WpAdmin.user.manage.add');
    }
    ...
    public function editUser($userUid)
    {
        ...
        return $this->loadManageView('WpAdmin.user.manage.edit', $processReaction['data']);
    }
    ...
    public function getUserDetails($userUid)
    {
        ...
        return $this->loadManageView('WpAdmin.user.manage.details', $processReaction['data']);
    }
    ...
    public function fetchFakeUserOptions()
    {
        ...
        return $this->loadManageView('WpAdmin.fake-data-generator.fake-users', $processReaction['data']);
    }
