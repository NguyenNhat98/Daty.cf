...
namespace App\Daty\Components\Item\Controllers;

use App\Daty\Base\BaseController;
use App\Daty\Components\Item\ManageStickerEngine;
use App\Daty\Components\Item\Requests\{StickerAddRequest, StickerEditRequest};
...
class ManageStickerController extends BaseController
{
    ...
    public function stickerListView()
    {
        ...
        return $this->loadManageView('WpAdmin.items.sticker.manage.list', $processReaction['data']);
	}
    ...
    {
        return $this->loadManageView('WpAdmin.items.sticker.manage.add');
	}
    ...
    public function stickerEditView($giftUId)
    {
        ...
        return $this->loadManageView('WpAdmin.items.sticker.manage.edit', $processReaction['data']);
	}
