...
namespace App\Daty\Components\WpAdmin\Item\Controllers;

use App\Daty\Base\BaseController;
use App\Daty\Components\WpAdmin\Item\ManageGiftEngine;
use App\Daty\Components\WpAdmin\Item\Requests\{GiftAddRequest, GiftEditRequest};
...
class ManageGiftController extends BaseController
{
    ...
    public function giftListView()
    {
        ...
        return $this->loadManageView('WpAdmin.items.gift.manage.list', $processReaction['data']);
	}
    ...
    {
        return $this->loadManageView('WpAdmin.items.gift.manage.add');
    }
    ...
    public function giftEditView($giftUId)
    {
        ...
        return $this->loadManageView('WpAdmin.items.gift.manage.edit', $processReaction['data']);
	}
