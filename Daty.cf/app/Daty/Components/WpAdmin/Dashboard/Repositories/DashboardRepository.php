...
namespace App\Daty\Components\WpAdmin\Dashboard\Repositories;

use App\Daty\Base\BaseRepository;
use App\Daty\Components\WpAdmin\User\Models\{ User };
use App\Daty\Components\WpAdmin\AbuseReport\Models\AbuseReportModel;
use App\Daty\Components\WpAdmin\FinancialTransaction\Models\FinancialTransaction;
use DB;
use Carbon\Carbon;
...
class DashboardRepository extends BaseRepository
{
    ...
    public function fetchOfflineUsers($status = 4)
    {
