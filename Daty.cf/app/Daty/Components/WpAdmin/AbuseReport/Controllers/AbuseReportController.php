...
namespace App\Daty\Components\WpAdmin\AbuseReport\Controllers;

use App\Daty\Base\BaseController;
use App\Daty\Components\WpAdmin\AbuseReport\ManageAbuseReportEngine;
use App\Daty\Components\WpAdmin\AbuseReport\Requests\{ModerateAbuseReportRequest};
...
class AbuseReportController extends BaseController
{
    ...
    public function reportListView($status)
    {
        ...
        return $this->loadManageView('WpAdmin.abuse-report.manage.list', $processReaction['data']);
	}
