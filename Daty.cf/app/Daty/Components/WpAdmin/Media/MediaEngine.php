...
namespace App\Daty\Components\WpAdmin\Media;
...
class MediaEngine extends BaseEngine
{
    /**
     * Constructor.
     *
...
//            {
//                return $this->engineReaction(2, null, __tr('Chỉ có __ex__ hình ảnh được chấp nhận.', [
...
//            }
            ...
            return $this->engineReaction(2, null, 'Đã xảy ra lỗi. Vui lòng thử lại');
