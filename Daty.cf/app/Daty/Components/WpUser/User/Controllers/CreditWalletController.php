...
use App\Daty\Components\WpUser\User\CreditWalletEngine;
use App\Daty\Components\WpUser\User\Requests\{PaypalTransactionRequest, PaymentProcessRequest};
// form Requests
...
class CreditWalletController extends BaseController
{
    ...
    public function creditWalletView()
    {
       $processReaction = $this->creditWalletEngine->prepareCreditWalletUserData();
        ...
        return $this->loadPublicView('WpUser.user.credit-wallet.credit-wallet', $processReaction['data']);
	}
