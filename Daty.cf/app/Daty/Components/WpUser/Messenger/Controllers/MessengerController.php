...
namespace App\Daty\Components\WpUser\Messenger\Controllers;

use App\Daty\Base\BaseController;
use App\Daty\Support\CommonUnsecuredPostRequest;
use App\Daty\Components\WpUser\Messenger\Requests\MessageRequest;
use App\Daty\Components\WpUser\Messenger\MessengerEngine;
...
class MessengerController extends BaseController
{
    ...
    {
        return $this->loadView('WpUser.messenger.chat-box');
    }
    ...
    public function getAllConversation()
    {
        ...
        return $this->responseAction(
            ...
            $this->replaceView('WpUser.messenger.chat', $processReaction['data'], '#lwMessengerContent')
        );
    }
    ...
    public function getUserConversation($userId)
    {
        ...
        return $this->responseAction(
            $this->processResponse($processReaction, [], [], true),
            $this->replaceView('WpUser.messenger.user-conversation', $processReaction['data'], '#lwUserConversationContainer')
        );
    }
