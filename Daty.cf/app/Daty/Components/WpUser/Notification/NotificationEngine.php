...
namespace App\Daty\Components\WpUser\Notification;
use Auth;
use App\Daty\Base\BaseEngine;
use App\Daty\Components\WpUser\Notification\Repositories\NotificationRepository;
    ...
    public function prepareNotificationList()
    {
        ...
        $requireColumns = [
			...
			'formattedIsRead' => function($key) {
				return (isset($key['is_read']) and $key['is_read'] == 1) ? 'Đồng ý' : 'Không';
			},
			'message'
		];
