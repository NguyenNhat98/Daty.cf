...
namespace App\Daty\Components\WpUser\Notification\Controllers;

use App\Daty\Support\CommonPostRequest;
use App\Daty\Base\BaseController;
use App\Daty\Components\WpUser\Notification\NotificationEngine;
...
class NotificationController extends BaseController
{
    ...
    {
        return $this->loadPublicView('WpUser.notification.notification-list');
	}
