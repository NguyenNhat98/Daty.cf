...
trait CommonTrait
{
    ...
    {
        return require app_path('Daty/Components/WpUser/UserSetting/Config/userSetting.php');
	}
    ...
    {
        return require app_path('Daty/Components/WpUser/UserSetting/Config/specification.php');
	}
