...
Route::group([
    'namespace' => '\App\Daty\Components',
], function () {

    Route::get('/change-language/{localeID}', [
        'as' => 'locale.change',
        'uses' => 'WpUser\Home\Controllers\HomeController@changeLocale',
    ]);

    // contact view
    Route::get('/contact', [
        'as' => 'user.read.contact',
        'uses' => 'WpUser\User\Controllers\UserController@getContactView'
    ]);

    // process contact form
    Route::post('/post-contact', [
        'as' => 'user.contact.process',
        'uses' => 'WpUser\User\Controllers\UserController@contactProcess',
    ]);

    // page preview
    Route::get('/page/{pageUId}/{title}', [
        'as' => 'page.preview',
        'uses' => 'WpUser\Home\Controllers\HomeController@previewPage',
    ]);
    ...
    Route::group(['middleware' => 'guest'], function () {
        ...
        Route::group([
            'namespace' => 'WpUser\Home\Controllers'
        ], function () {
        ...
        Route::group([
            'namespace' => 'WpUser\User\Controllers',
            'prefix' => 'user',
        ], function () {
            // login
            Route::get('/login', [
    ...
    Route::group(['middleware' => 'auth'], function () {
        ...
        Route::get('/home', [
            'as' => 'home_page',
            'uses' => 'WpUser\Home\Controllers\HomeController@homePage',
        ]);

        // Get User Profile view
        Route::get('/@{username}', [
            'as' => 'user.profile_view',
            'uses' => 'WpUser\User\Controllers\UserController@getUserProfile'
        ]);
        // Get user profile data
        Route::get('/{username}/get-user-profile-data', [
            'as' => 'user.get_profile_data',
            'uses' => 'WpUser\User\Controllers\UserController@getUserProfileData'
        ]);
        // View photos settings
        Route::get('/@{username}/photos', [
            'as' => 'user.photos_setting',
            'uses' => 'WpUser\UserSetting\Controllers\UserSettingController@getUserPhotosSetting',
        ]);
        ...
        ----------------------------------------------------------------------- */
        Route::group([
            'namespace' => 'WpUser\Filter\Controllers',
        ], function () {
        ...
        Route::group([
            ...
            Route::group([
                'namespace' => 'WpUser\UserSetting\Controllers',
                'prefix' => 'settings'
            ], function () {
                // View settings
                Route::get('/{pageType}', [
            ...
            Route::group([
                'namespace' => 'WpUser\Messenger\Controllers',
                'prefix' => 'messenger'
            ], function () {
            ...
            Route::group([
                'namespace' => 'WpUser\Notification\Controllers',
