		...
		<fieldset class="lw-fieldset mb-3">
			...
			<legend class="lw-fieldset-legend">
				...
				<div class="custom-control custom-switch">
					...
					<label class="custom-control-label" for="lwAllowPusher">Cho phép Pusher</label>
				</div>
			</legend>
			<!-- /allow pusher input radio field -->
			...
			<div class="btn-group" id="lwIsPusherKeysExist"  style="display:none">
				<button type="button" disabled="true" class="btn btn-success lw-btn">Các khóa Pusher đã được cài đặt</button>
				<button type="button" class="btn btn-light lw-btn" id="lwAddPusherKeys">Cập nhật</button>
			</div>
			<!-- show after pusher allow information -->
			...
			<div id="lwPusherInputField">
				<!-- Pusher App ID Key -->
				<div class="mb-3">
                    <label for="lwPusherAppId">ID Pusher</label>
					<input type="text" class="form-control form-control-user" name="pusher_app_id" placeholder="Thêm ID ứng dụng Pusher của bạn" id="lwPusherAppId">
				</div>
				<!-- / Pusher App ID Key -->

				<!-- Pusher App key -->
				<div class="mb-3">
                    <label for="lwPusherAppKey">Khóa Pusher</label>
					<input type="text" class="form-control form-control-user" name="pusher_app_key" placeholder="Thêm khóa ứng dụng Pusher của bạn" id="lwPusherAppKey">
				</div>
				<!-- / Pusher App key -->

				<!-- Pusher App Secret -->
				<div class="mb-3">
                    <label for="lwPusherAppSecret">Khóa bí mật Pusher</label>
					<input type="text" class="form-control form-control-user" name="pusher_app_secret" placeholder="Thêm bí mật ứng dụng Pusher của bạn" id="lwPusherAppSecret">
				</div>
				<!-- / Pusher App Secret -->

				<!-- Pusher App Cluster key -->
				<div class="mb-3">
                    <label for="lwPusherAppClusterKey">Khóa cụm ứng dụng Pusher</label>
					<input type="text" class="form-control form-control-user" name="pusher_app_cluster_key" placeholder="Thêm khóa cụm ứng dụng Pusher của bạn" id="lwPusherAppClusterKey">
				</div>
				<!-- / Pusher App Cluster key -->
			</div>
			<!-- /PUSHER SETTING DATA -->
			...
			<fieldset class="lw-fieldset mb-3 mt-4">
				...
				<legend class="lw-fieldset-legend">
					...
					<div class="custom-control custom-switch">
						...
						<label class="custom-control-label" for="lwAllowAgora">Cho phép Agora (Cuộc gọi âm thanh / video)</label>
					</div>
				</legend>
				<!-- /allow agora input radio field -->
				...
				<div class="btn-group" id="lwIsAgoraKeysExist"  style="display:none">
					<button type="button" disabled="true" class="btn btn-success lw-btn">Các khóa Agora đã được cài đặt </button>
					<button type="button" class="btn btn-light lw-btn" id="lwAddAgoraKeys">Cập nhật</button>
				</div>
				<!-- show after agora allow information -->
				...
				<div id="lwAgoraInputField">
					<!-- Agora App ID Key -->
					<div class="mb-3">
						<label for="lwAgoraAppId">ID Agora</label>
						<input type="text" class="form-control form-control-user" name="agora_app_id" placeholder="Thêm ID ứng dụng Agora của bạn>" id="lwAgoraAppId">
					</div>
					<!-- / Agora App ID Key -->

					<!-- Agora App Certificate Key -->
					<div class="mb-3">
						<label for="lwAgoraAppKey">Khóa chứng chỉ ứng dụng Agora</label>
						<input type="text" class="form-control form-control-user" name="agora_app_certificate_key" placeholder="Thêm khóa chứng chỉ ứng dụng Agora của bạn" id="lwAgoraAppKey">
					</div>
					<!-- / Agora App Certificate Key -->
				</div>
				<!-- /agora app id or app certificate key input field-->
		...
		<fieldset class="lw-fieldset mb-3">
			...
			<legend class="lw-fieldset-legend">
				...
				<div class="custom-control custom-switch">
					...
					<label class="custom-control-label" for="lwAllowGoogleMap">Cho phép Google Map</label>
				</div>
			</legend>
			<!-- /allow google map input radio field -->
			...
			<div class="btn-group" id="lwIsGoggleMapKeysExist"  style="display:none">
				<button type="button" disabled="true" class="btn btn-success lw-btn">Các khóa bản đồ Google đã được cài đặt</button>
				<button type="button" class="btn btn-light lw-btn" id="lwAddGoogleMapKeys">Cập nhật</button>
			</div>
			<!-- show after google map allow information -->
			...
			<div id="lwGoogleMapInputField">
				<!-- Google Map Key Key -->
				<div class="mb-3">
                    <label for="lwGoogleMapKey">Khóa bản đồ Google</label>
					<input type="text" class="form-control form-control-user" name="google_map_key" placeholder="Thêm khóa bản đồ Google của bạn" id="lwGoogleMapKey">
				</div>
				<!-- /Google Map Key Key -->
			</div>
		</fieldset>
		...
		<fieldset class="lw-fieldset mb-3">
			...
			<legend class="lw-fieldset-legend">
				...
				<div class="custom-control custom-switch">
					...
					<label class="custom-control-label" for="lwAllowGiphy">Cho phép Giphy</label>
				</div>
			</legend>
			<!-- /allow giphy input radio field -->
			...
			<div class="btn-group" id="lwIsGiphyKeysExist"  style="display:none">
				<button type="button" disabled="true" class="btn btn-success lw-btn">Các khóa Giphy đã được cài đặt</button>
				<button type="button" class="btn btn-light lw-btn" id="lwAddGiphyKeys">Cập nhật</button>
			</div>
			<!-- show after giphy allow information -->
			...
			<div id="lwGiphyKeyInputField">
				<!-- Giphy Key -->
				<div class="mb-3">
                    <label for="lwGiphyKey">Khóa Giphy</label>
					<input type="text" class="form-control form-control-user" name="giphy_key" placeholder="Thêm khóa Giphy của bạn" id="lwGiphyKey">
				</div>
				<!-- /Giphy Key -->
			</div>
		</fieldset>
