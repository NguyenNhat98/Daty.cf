<!-- Page Heading -->
<h3>Cài đặt đăng nhập xã hội</h3>
<!-- /Page Heading -->
<hr>
<!-- User Setting Form -->
		...
		<fieldset class="lw-fieldset mb-3">
			...
			<legend class="lw-fieldset-legend">
				<div class="custom-control custom-switch">
					...
					<label class="custom-control-label" for="lwAllowFacebookLogin">Cho phép đăng nhập Facebook</label>
				</div>
			</legend>
			<!-- /allow facebook login input radio field -->
			...
			<div class="btn-group" id="lwIsFacebookKeysExist"  style="display:none">
				<button type="button" disabled="true" class="btn btn-success lw-btn">Khóa Facebook đã được cài đặt.</button>
				<button type="button" class="btn btn-light lw-btn" id="lwAddFacebookKeys">Cập nhật</button>
			</div>
			<!-- show after facebook login allow information -->
			...
			<div id="lwFacebookLoginInputField">
				...
				<div class="mb-3">
                    <label for="lwFacebookCallback Url">URL</label>
		...
		<fieldset class="lw-fieldset mb-3">
			...
			<legend class="lw-fieldset-legend">
				<div class="custom-control custom-switch">
					...
					<label class="custom-control-label" for="lwAllowGoogleLogin">Cho phép đăng nhập Google</label>
				</div>
			</legend>
			<!-- /allow google login input radio field -->
			...
			<div class="btn-group" id="lwIsGoogleKeysExist"  style="display:none">
				<button type="button" disabled="true" class="btn btn-success lw-btn">Khóa Google đã được cài đặt.</button>
				<button type="button" class="btn btn-light lw-btn" id="lwAddGoogleKeys">Cập nhật</button>
			</div>
			<!-- show after google login allow information -->
