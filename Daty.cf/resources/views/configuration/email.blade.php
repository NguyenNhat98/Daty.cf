...
<form class="lw-ajax-form lw-form" method="post" action="<?= route('manage.configuration.write', ['pageType' => request()->pageType]) ?>">
    ...
    <div class="form-group row mt-2">
    	...
    	<div class="custom-control custom-switch">
			...
			<label class="custom-control-label" for="forEnvDefaultSettings">Cài đặt mặc định </label>
		</div>
		<!-- / for env switch -->
	</div>
	...
	<div id="lwAllFormFieldsBlock">
		...
		<div class="form-group row">
			...
			<div class="col-sm-6 mb-3 mb-sm-0">
	            <label for="lwMailFromAddress">Thư từ địa chỉ</label>
			...
			<!-- / Mail From Address -->
		 	<!-- Number of users -->
			<div class="col-sm-6 mb-3 mb-sm-0">
	            <label for="lwMailFromName">Tên người gửi</label>
		...
		<div id="lwSmtpBlock">
			<fieldset class="lw-fieldset mb-3">
				...
				<div class="form-group row">
					...
					<!-- Mail Encryption -->
					<div class="col-sm-4 mb-3 mb-sm-0">
	            		<label for="lwMailEncryption">Kiểu mã hóa Email</label>
						<select id="lwMailEncryption" class="form-control" placeholder="Kiểu mã hóa Email" name="smtp_mail_encryption" required>
