...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
	<h1 class="h3 mb-0 text-gray-200">Thêm gói tín dụng</h1>
	<!-- back button -->
	<a class="btn btn-light btn-sm" href="<?= route('manage.credit_package.read.list') ?>">
		<i class="fa fa-arrow-left" aria-hidden="true"></i> Quay lại các gói tín dụng
	</a>
	<!-- /back button -->
</div>
			...
			<div class="card-body">
                ...
                <form class="lw-ajax-form lw-form" method="post" action="<?= route('manage.credit_package.write.add') ?>">
					...
					<!-- / title input field -->
 					<div class="form-group row">
						...
						<div class="col-sm-6 mb-3 mb-sm-0">
							<label for="lwPrice">Giá bình thường</label>
						...
						<!-- Credits field -->
						<div class="col-sm-6 mb-3 mb-sm-0">
							<label for="lwCredit">Giá cao cấp</label>
					...
					<div class="custom-control custom-checkbox custom-control-inline">
						...
						<label class="custom-control-label" for="statusCheck">Hoạt động</label>
					</div>
					<!-- / status field -->
					<br><br>
