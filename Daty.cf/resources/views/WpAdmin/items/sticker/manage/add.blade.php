@section('page-title', 'Thêm hình dán')
@section('head-title', 'Thêm hình dán')
<!-- Page Heading -->
<div class="d-sm-flex align-items-center justify-content-between mb-4">
	<h1 class="h3 mb-0 text-gray-200">Thêm hình dán</h1>
	<!-- back button -->
			...
			<div class="card-body">
				...
				<form class="lw-ajax-form lw-form" method="post" action="<?= route('manage.item.sticker.write.add') ?>">
					...
					<div class="form-group row">
						...
						<!-- premium price field -->
						<div class="col-sm-6 mb-3 mb-sm-0">
 							<label for="lwPremiumPrice">Giá cao cấp</label>
							<div class="input-group">
