@section('page-title', 'Chỉnh sửa quà tặng')
@section('head-title', 'Chỉnh sửa quà tặng')
<!-- Page Heading -->
<div class="d-sm-flex align-items-center justify-content-between mb-4">
	<h1 class="h3 mb-0 text-gray-200">Chỉnh sửa quà tặng</h1>
	<!-- back button -->
	<a class="btn btn-light btn-sm" href="<?= route('manage.item.gift.view') ?>">
		<i class="fa fa-arrow-left" aria-hidden="true"></i> Trở lại
	</a>
	<!-- /back button -->
</div>
			...
			<div class="card-body">
                ...
                <form class="lw-ajax-form lw-form" method="post" action="<?= route('manage.item.gift.write.edit', ['giftUId' => $giftEditData['_uid']]) ?>">
					...
					<div class="form-group">
                        <label for="lwTitle">Tiêu đề</label>
					...
					<!-- / title input field -->
 					<div class="form-group row">
						...
						<!-- premium price field -->
						<div class="col-sm-6 mb-3 mb-sm-0">
 							<label for="lwPremiumPrice">Giá cao cấp</label>
							<div class="input-group">
					...
					<br><br>
					<!-- Update button -->
					<button type="submit" class="lw-ajax-form-submit-action btn btn-primary btn-user lw-btn-block-mobile">Cập nhật</button>
					<!-- / Update button -->
				</form>
				<!-- / page add form -->
			</div>
