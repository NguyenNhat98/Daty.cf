@section('page-title', 'Thông báo')
@section('head-title', 'Thông báo')
@section('keywordName', 'Thông báo')
@section('keyword', 'Thông báo')
@section('description', 'Thông báo')
@section('keywordDescription', 'Thông báo')
...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
	...
	<span class="text-primary"><i class="far fa-bell"></i></span> Thông báo</h5>
</div>
