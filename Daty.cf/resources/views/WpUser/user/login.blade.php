...
@section('keywordName', strip_tags('Đăng nhập'))
@section('keyword', strip_tags('Đăng nhập'))
@section('description', strip_tags('Đăng nhập'))
@section('keywordDescription', strip_tags('Đăng nhập'))
                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        <hr class="mt-4 mb-4">
                                            <h4 class="text-gray-200 mb-4">ĐĂNG NHẬP TÀI KHOẢN</h4>
                                    ...
                                    <form class="user lw-ajax-form lw-form" data-callback="onLoginCallback" method="post" action="<?= route('user.login.process') ?>" data-show-processing="true" data-secured="true">
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user" name="email_or_username" aria-describedby="emailHelp" placeholder="Email hoặc tên người dùng ..." required>
                                        </div>
                                        <!-- / email input field -->
                                        ...
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox small">
                                                ...
                                                <label class="custom-control-label text-gray-200" for="rememberMeCheckbox">Ghi nhớ</label>
                                            </div>
                                        </div>
                                        <!-- remember me input field -->

                                        <!-- login button -->
                                        <button type="submit" value="Login" class="lw-ajax-form-submit-action btn btn-primary btn-user btn-block">ĐĂNG NHẬP</button>
                                        <!-- / login button -->
                                        <!-- social login links -->
                                    ...
                                    <div class="text-center">
                                        <p><?= __tr("Không có tài khoản tạo mới miễn phí!!") ?></p>
                                        <a class="btn btn-success" href="<?= route('user.sign_up') ?>">TẠO TÀI KHOẢN!</a>
                                    </div>
                                    <!-- / create account button -->
                                </div>
                            </div>
